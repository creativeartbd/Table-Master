 ...
 * @author     Shibbir Ahmed <shibbir.me>
...
/**
 * Main Table Master Class
 * The init class that runs the Table Master plugin.
 * Intended To make sure that the plugin's minimum requirements are met.
 */

final class Table_Master {
	...
	public function i18n() {
		load_plugin_textdomain( 'table-master' );
	}
